...
$currentPage = 'birds';
$pageTitle = 'زیادکردنی هەوێردەی مێ';
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (empty($batch_name) || $quantity <= 0) {
        ...
        $db->query("INSERT INTO female_birds (batch_name, quantity, entry_date, status, notes, created_at) 
        ...
        if ($db->execute()) {
            header('Location: female_list.php?success=1');
            exit;
        } else {
...
<div class="page-header">
    <div>
        <h2><i class="fas fa-plus"></i> زیادکردنی هەوێردەی مێ</h2>
    ...
    <div class="col-lg-8">
        <div class="card">
            <div class="card-header bg-danger-gradient">
                <i class="fas fa-venus"></i> زانیاری گرووپی هەوێردەی مێ
            </div>
            <div class="card-body">
                    ...
                    <div class="row g-3">
                        ...
                        <div class="col-md-6">
                            ...
                            <select name="status" class="form-select">
                                ...
                                <option value="laying">هێلکەدان</option>
