...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    if (empty($batchName) || $quantity <= 0 || empty($entryDate)) {
        ...
        $db->query("UPDATE female_birds SET batch_name = :name, quantity = :qty, entry_date = :date, status = :status, notes = :notes WHERE id = :id");
                    ...
                    <div class="row g-3">
                        ...
                        <div class="col-md-6">
                            ...
                            <select name="status" class="form-select">
                                ...
                                <option value="laying" <?php echo $bird['status'] == 'laying' ? 'selected' : ''; ?>>هێلکەدان</option>
