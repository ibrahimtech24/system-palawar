...
$currentPage = 'birds';
$pageTitle = 'دەستکاری هەوێردەی نێر';

$id = $_GET['id'] ?? 0;

// Get bird data
$db->query("SELECT * FROM male_birds WHERE id = :id");
$db->bind(':id', $id);
$bird = $db->single();

if (!$bird) {
    header('Location: male_list.php');
    exit;
}
...
<div class="page-header">
    <div>
        <h2><i class="fas fa-edit"></i> دەستکاری هەوێردەی نێر</h2>
