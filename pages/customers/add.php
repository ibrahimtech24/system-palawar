...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    if (empty($name)) {
        ...
        $db->query("INSERT INTO customers (name, phone, address, notes, created_at) VALUES (:name, :phone, :address, :notes, NOW())");
        $db->bind(':name', $name);
        $db->bind(':phone', $phone);
...
<div class="page-header">
    <div>
        <h2><i class="fas fa-user-plus"></i> زیادکردنی کڕیار</h2>
